...
WINDOWS_ASSET_URL='https://github.com/EmiyaKatuz/Codex-Dream-Skin-Needy-Girl-Overdose/blob/main/windows/assets/'
...
for file in "$DOCS_TARGET"/*.md; do
  ...
  /usr/bin/sed \
    ...
    -e "s#https://github.com/EmiyaKatuz/Codex-Dream-Skin-Needy-Girl-Overdose/tree/main/windows/assets/#${WINDOWS_ASSET_TOKEN}#g" \
